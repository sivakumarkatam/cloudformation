...
variable "aws_iam_role_lambda_arn" {
  description = " Enter aws_iam_role_lambda_arn"
  type        = "string"
#  default     = false
}

variable "subnet_a" {
  description = " Enter subnet A"
  type        = "string"
#  default     = false
}

variable "subnet_b" {
  description = " Enter subnet B"
  type        = "string"
#  default     = false
}

variable "security_group_ids" {
  description = " Enter security_group_ids "
  type        = "string"
#  default     = false
}
...
variable "api_name" {
  description = " Enter Api Gateway Name "
  type        = "string"
#  default     = false
}
